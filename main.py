...
from model.SelectScale_DualHyper import Model
import numpy as np
# torch
import torch
...
class Processor():
    ...
    # def load_optimizer(self):
    #     pool1 = list(map(id, self.model.module.l5.pool.parameters()))
    #     pool2 = list(map(id, self.model.module.l8.pool.parameters()))
    #     base_params = filter(lambda p: id(p) not in pool1 + pool2, self.model.module.parameters())

    #     if self.arg.optimizer == 'SGD':
    #         self.optimizer = optim.SGD(
    #             [{'params': base_params}, 
    #              {'params': self.model.module.l5.pool.parameters(), 'lr': self.arg.base_lr * 100},
    #              {'params': self.model.module.l8.pool.parameters(), 'lr': self.arg.base_lr * 100}],
    #             lr=self.arg.base_lr,
    #             momentum=0.9,
    #             nesterov=self.arg.nesterov,
    #             weight_decay=self.arg.weight_decay)
    ...
    #         self.optimizer = optim.Adam(
    #             [{'params': base_params}, 
    #              {'params': self.model.l5.pool.parameters(), 'lr': self.arg.base_lr * 100},
    #              {'params': self.model.l8.pool.parameters(), 'lr': self.arg.base_lr * 100}],
    #             lr=self.arg.base_lr,
    #             weight_decay=self.arg.weight_decay)
    #     else:
    #         raise ValueError()
